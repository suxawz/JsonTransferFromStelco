...
$query = " SELECT  [BOFModelParameterMatrixID]
      ,[BOFModelParameterID]
      ,[KEY1]
      ,[KEY2]
      ,[VALUE]
  FROM [meltshopStelco].[dbo].[tblBOFModelParameterMatrix] order by BOFModelParameterID  "
...
$filePathDay = "tblBOFModelParameterMatrix"+$endDay
